// agentrouter/share-session.js
//
// Снимает «живую» сессию аккаунта AgentRouter (cookies GitHub + agentrouter + localStorage)
// в Playwright storageState-формате и сохраняет в agentrouter/sessions/<label>.json.
//
// Использование:
//   node agentrouter/share-session.js <label>
