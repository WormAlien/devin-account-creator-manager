...
const REGISTER_URL = require("../routing/lib/ref-codes.js").url("gorouter");
...
//   share-код друга      → аккаунт gorouter уже создан, GitHub/gorouter сразу залогинены;
//   seed:'github'        → только GitHub-куки, аккаунта gorouter ещё НЕТ (см. seededGithub).
...
async function main() {
  ...
  try {
    ...
    if (!loggedInEarly) console.log('   затем возьми ключ в консоли gorouter и вставь его кнопкой 🔑 в дашборде.');
