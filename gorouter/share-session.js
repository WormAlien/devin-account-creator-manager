// gorouter/share-session.js
//
// Снимает «живую» сессию аккаунта GoRouter (cookies GitHub + gorouter + localStorage)
// в Playwright storageState-формате и сохраняет в gorouter/sessions/<label>.json.
//
// Использование:
//   node gorouter/share-session.js <label>
