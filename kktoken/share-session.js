// kktoken/share-session.js
//
// Снимает «живую» сессию аккаунта KKtoken (cookies GitHub + kktoken + localStorage)
// в Playwright storageState-формате и сохраняет в kktoken/sessions/<label>.json.
//
// Использование:
//   node kktoken/share-session.js <label>
