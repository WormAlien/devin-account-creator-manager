// seekai/share-session.js
//
// Снимает «живую» сессию аккаунта SeekAi (cookies GitHub + seekai + localStorage)
// в Playwright storageState-формате и сохраняет в seekai/sessions/<label>.json.
//
// Использование:
//   node seekai/share-session.js <label>
