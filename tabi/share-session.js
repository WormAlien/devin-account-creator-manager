// tabi/share-session.js
//
// Снимает «живую» сессию аккаунта Tabi (cookies GitHub + tabitoken + localStorage)
// в Playwright storageState-формате и сохраняет в tabi/sessions/<label>.json.
//
// Использование:
//   node tabi/share-session.js <label>
