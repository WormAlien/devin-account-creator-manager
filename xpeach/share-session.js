// xpeach/share-session.js
//
// Снимает «живую» сессию аккаунта XPeach (cookies GitHub + xpeach.codes +
// localStorage) в Playwright storageState-формате и сохраняет в
// xpeach/sessions/<label>.json.
//
// Использование:
//   node xpeach/share-session.js <label>
